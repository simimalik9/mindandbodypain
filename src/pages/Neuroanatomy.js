...
function Neuroanatomy({ t }) {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-cover bg-center text-white py-24 px-4 sm:px-6 lg:px-8" style={{ backgroundImage: "url('/neuroanatomybackground.jpg')" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-1">
              <img src="/cerebrum.png" alt="Cerebrum" className="w-full h-auto object-cover -ml-4 md:ml-0"/>
            </div>
      ...
      <section className="pt-8 pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            {/* Column 3: Image */}
            <div className="lg:col-span-1">
              <img src="/brainstructures.png" alt="Key Brain Structures" className="w-full max-w-md h-auto object-cover mb-8"/>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-1 space-y-4">
              <img src="/alzheimers.jpg" alt="Neurodegenerative Diseases" className="w-full max-w-md h-auto object-cover mb-8"/>
